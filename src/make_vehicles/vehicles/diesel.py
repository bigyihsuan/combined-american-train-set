...
def make_emd_gp9(root: str, name: str):
    '''
    EMD GP9 is a single-unit diesel loco.
    '''
...
def make_emd_sd9(root: str, name: str):
    '''
    EMD SD9 is a single-unit diesel loco.
    '''
    simple_vehicle(root, name)
...
def make_emd_sd45(root: str, name: str):
    '''
    EMD SD45 is a single-unit diesel loco.
    '''
    simple_vehicle(root, name)
...
def make_emd_sd402(root: str, name: str):
    '''
    EMD SD40-2 is a single-unit diesel loco.
    '''
    simple_vehicle(root, name)
...
def make_emd_gp382(root: str, name: str):
    '''
    EMD GP38-2 is a single-unit diesel loco.
    '''
    simple_vehicle(root, name)
